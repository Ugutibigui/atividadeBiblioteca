                                                    ...
                                                    <form class="form" action="../scripts/edit.php" method="POST">
                                                        <div class="top-form">
                                                            <div class="left-form">
                                                                ...
                                                                <div class="item">
                                                                    <p>Autor (nome)</p>
                                                                    <input type="text" name="autorNomeUm" id="autorNomeUm" value="<?= $row["NomeAutor1"] ?>" required>
                                                                </div>
                                                                <div class="item">
                                                                    <p>Autor (nome)</p>
                                                                    <input type="text" name="autorNomeDois" id="autorNomeDois" value="<?= $row["NomeAutor2"] ?>" required>
                                                                </div>
                                                                <div class="item">
                                                                    <p>Autor (nome)</p>
                                                                    <input type="text" name="autorNomeTres" id="autorNomeTres" value="<?= $row["NomeAutor3"] ?>" required>
                                                                </div>
                                                                <div class="item">
                                                                    <p>Editora</p>
                                                                    <input type="text" name="editora" id="editora" value="<?= $row["editora"] ?>" required>
                                                                </div>
                                                                <div class="item">
                                                                    <p>ISBN</p>
                                                                    <input name="isbn" id="isbn" value="<?= $row["isbn"] ?>" required>
                                                                </div>
                                                            </div>
                                                            <div class="rigth-form">
                                                                <div class="item">
                                                                    <p>Subtitulo</p>
                                                                    <input type="text" name="subtitulo" id="subtitulo" value="<?= $row["subtitulo"] ?>" required>
                                                                </div>
                                                                <div class="item">
                                                                    <p>Autor (sobrenome)</p>
                                                                    <input type="text" name="autorSobrenomeUm" id="autorSobrenomeUm" value="<?= $row["SobreNomeAutor1"] ?>" required>
                                                                </div>
                                                                <div class="item">
                                                                    <p>Autor (sobrenome)</p>
                                                                    <input type="text" name="autorSobrenomeDois" id="autorSobrenomeDois" value="<?= $row["SobreNomeAutor2"] ?>" required>
                                                                </div>
                                                                <div class="item">
                                                                    <p>Autor (sobrenome)</p>
                                                                    <input type="text" name="autorSobrenomeTres" id="autorSobrenomeTres" value="<?= $row["SobreNomeAutor3"] ?>" required>
                                                                </div>
                                                                <div class="align-item">
                                                                    <div class="itemd">
                                                                        <p>Categoria</p>
                                                                        <input name="categoria" id="categoria" value="<?= $row["categoria"] ?>" required>
                                                                    </div>
                                                                    <div class="itemd">
                                                                        <p>Ano</p>
                                                                        <input name="ano" id="ano" value="<?= $row["ano"] ?>" required>
                                                                    </div>
                                                                </div>
                                                                <div class="align-item">
                                                                    <div class="itemd">
                                                                        <p>Vol.</p>
                                                                        <input type="text" name="volume" id="volume" value="<?= $row["volume"] ?>" required>
                                                                    </div>
                                                                    <div class="itemd">
                                                                        <p>Preço</p>
                                                                        <input name="preco" id="preco" value="<?= $row["valor"] ?>" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
